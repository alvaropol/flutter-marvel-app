...
class CharacterRepositoryImpl extends CharacterRepository {
  ...
  @override
  Future<List<Results>?> fetchCharacterDetail(int characterId) async {
    final response = await _httpClient.get(Uri.parse(
        'https://gateway.marvel.com/v1/public/characters/$characterId?ts=1&apikey=73d03ea66b154cd4d860e01c3e78e33c&hash=0b5a97a285f74eaa0658001b5127b3ce'));
    if (response.statusCode == 200) {
      return DetailCharacterResponse.fromJson(json.decode(response.body))
          .data
          ?.results;
    } else {
      throw Exception('Failed to load detail of the character');
    }
  }
}
